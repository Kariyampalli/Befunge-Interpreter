...
namespace BefungeInterpreter.Commands
{
    public class Subtraction : ICommand
    {
        ...
        public object Work(InterpreterStack stack)
        {
            ...
            {
                throw new InvalidOperationException("Stack doesn't have enough values for subtraction operation or the values within the stack for the operation are invalid!");
            }
            return b - a;
        }
    }
