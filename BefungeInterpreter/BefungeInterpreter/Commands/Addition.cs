...
namespace BefungeInterpreter.Commands
{
    public class Addition : ICommand
    {
        ...
        public object Work(InterpreterStack stack)
        {
            ...
            {
                throw new InvalidOperationException("Stack doesn't have enough values for addition operation or the values within the stack for the operation are invalid!");
            }     
            return a + b;
        }
    }
